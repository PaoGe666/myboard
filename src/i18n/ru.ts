...
const ru: LANG_MESSAGE = {
  ...
  search: 'Поиск',
  importFromShareLink: 'Импорт из share-link',
  importParse: 'Разобрать и заполнить',
  shareLinkImportSuccess: 'Разобрано и заполнено',
  shareLinkImportError: 'Не удалось разобрать ссылку',
  ...
  enabled: 'Включено',
  searchMultiple: 'Поиск нескольких',
