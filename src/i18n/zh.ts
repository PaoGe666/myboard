...
const zh: LANG_MESSAGE = {
  ...
  reloadConfigs: '重载配置',
  updateConfigs: '更新配置',
  vlessSubscription: '从 Base64 创建 VLESS 订阅',
  vlessSubscriptionTip: '粘贴 Base64 订阅内容并命名，节点会保存为路由器上的本地订阅。',
  vlessSubscriptionInput: 'Base64 内容',
  vlessSubscriptionInputPlaceholder: '在此粘贴 Base64 编码的 VLESS 节点',
  vlessSubscriptionOutput: '解码后的 VLESS 链接',
  vlessSubscriptionCount: '已解码 {count} 个 VLESS 节点',
  vlessSubscriptionCreate: '创建本地订阅',
  vlessSubscriptionCreated: '本地 VLESS 订阅已创建',
  vlessSubscriptionInvalidContent: '解码内容中包含非 VLESS 节点行。',
  vlessSubscriptionDecodeFailed: '解码失败，请检查输入是否为有效的 Base64 UTF-8 文本。',
  vlessSubscriptionCopyFailed: '复制失败，请检查浏览器剪贴板权限。',
  ...
  testAllSubscriptions: '测试所有已启用订阅的节点延迟',
  ...
  nodeGroups: '节点组',
  noAvailableProxy: '无可用节点',
  unavailableGroupCount: '{count} 组异常',
  preferBrandSvgIcon: '优先使用品牌 SVG 图标源',
  enabled: '启用',
  searchMultiple: '搜索多个',
