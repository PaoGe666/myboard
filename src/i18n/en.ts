const en = {
  ...
  search: 'Search',
  importFromShareLink: 'Import from share link',
  importParse: 'Parse & fill',
  shareLinkImportSuccess: 'Parsed and filled',
  shareLinkImportError: 'Failed to parse link',
  ...
  deleteCustomNodeMessage: 'Delete custom node {name}?',
  addCustomNode: 'Add Node',
  updateNodeSuccess: 'Node updated',
  server: 'Server',
  uuid: 'UUID',
  alterId: 'alterId',
  cipher: 'Cipher',
  ...
  enabled: 'Enabled',
  searchMultiple: 'Search multiple',
