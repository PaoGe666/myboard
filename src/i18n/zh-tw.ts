...
const zhTW: LANG_MESSAGE = {
  ...
  reloadConfigs: '重載配置',
  updateConfigs: '更新配置',
  vlessSubscription: '從 Base64 建立 VLESS 訂閱',
  vlessSubscriptionTip: '貼上 Base64 訂閱內容並命名，節點會儲存為路由器上的本機訂閱。',
  vlessSubscriptionInput: 'Base64 內容',
  vlessSubscriptionInputPlaceholder: '在此貼上 Base64 編碼的 VLESS 節點',
  vlessSubscriptionOutput: '解碼後的 VLESS 連結',
  vlessSubscriptionCount: '已解碼 {count} 個 VLESS 節點',
  vlessSubscriptionCreate: '建立本機訂閱',
  vlessSubscriptionCreated: '本機 VLESS 訂閱已建立',
  vlessSubscriptionInvalidContent: '解碼內容中包含非 VLESS 節點行。',
  vlessSubscriptionDecodeFailed: '解碼失敗，請檢查輸入是否為有效的 Base64 UTF-8 文字。',
  vlessSubscriptionCopyFailed: '複製失敗，請檢查瀏覽器剪貼簿權限。',
  ...
  search: '搜尋',
  importFromShareLink: '從分享連結匯入',
  importParse: '解析並填入',
  shareLinkImportSuccess: '已解析並填入',
  shareLinkImportError: '無法解析該連結',

  testing: '正在測',

  testAllCustomNodes: '批次測速',
  testAllSubscriptions: '測試所有已啟用訂閱的節點延遲',
  testNodeGroup: '測試此節點組',

  editCustomNode: '編輯節點',
  deleteCustomNode: '刪除節點',
  deleteCustomNodeMessage: '確定刪除自訂節點 {name}？',
  addCustomNode: '新增節點',
  updateNodeSuccess: '已更新節點',
  server: '伺服器',
  uuid: 'UUID',
  alterId: 'alterId',
  cipher: '加密',
  ...
  providerUrl: '訂閱連結(URL)',
  addProviderHint: '將透過 OpenClash 寫入設定新增該訂閱並重載。',
  add: '新增',
  addProviderSuccess: '已新增訂閱',
  addProviderRequireFields: '請填寫訂閱名稱和連結',

  deleteProviderTitle: '刪除訂閱',
  deleteProviderMessage: '確定刪除訂閱 {name}？節點將從面板移除。',
  deleteProviderSuccess: '已刪除訂閱',
